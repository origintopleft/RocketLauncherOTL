...
void RocketLauncher2::on_listbox_engines_clicked(const QModelIndex &index)
{
    ...
    if (pic == Pic_Default)
        ...
        ui->combo_EngPic->setCurrentText("UZdoom");
    else if (pic == Pic_Woof)
        ui->combo_EngPic->setCurrentText("Woof");
}
...
void RocketLauncher2::on_combo_EngPic_currentTextChanged(const QString &arg1)
{
    ...
    if (arg1 == "Default")
        ...
        enginelist->setPicFromIndex(Pic_UZdoom, index);
    else if (arg1 == "Woof")
        enginelist->setPicFromIndex(Pic_Woof, index);
